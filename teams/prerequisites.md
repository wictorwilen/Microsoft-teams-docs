...
* Include the [Microsoft Teams JavaScript library](jslibrary) in your page as a script source.
...
* All domains for pages you display in your tabs must be listed in the manifest's `validDomains` list. See [validDomains](schema#validdomains) in the manifest schema reference for more information.

>Hitting problems? See the [troubleshooting guide](troubleshooting).
